...
import { FormField } from '../../../renderers/index.ts'
import { ConfigEmptyState } from '../../../components/index.ts'
				...
				return (
					...
					>
						<FormField
							...
							value={value}
							onChange={() => {}} // No-op for show page
							disabled={true} // Always disabled on show page
						/>
					</div>
				)
			})}
